...
import (
	...
	"github.com/RXWatcher/silo-plugin-ebooks/internal/consumer"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/event"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/httproutes"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/koboref"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/recommend"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/migrate"
	pluginrt "github.com/RXWatcher/silo-plugin-ebooks/internal/runtime"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/scheduler"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/server"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/store"
	"github.com/RXWatcher/silo-plugin-ebooks/internal/streaming"
	"github.com/RXWatcher/silo-plugin-ebooks/web"
)
...
func main() {
	logger := hclog.New(&hclog.LoggerOptions{Name: "silo-plugin-ebooks"})
	...
	rt := pluginrt.New(manifest, func(cfg pluginrt.Config) error {
		...
		// makes it available through SILO_PLUGIN_TOKEN.
		hostBase := os.Getenv("SILO_HOST_BASE_URL")
		if hostBase == "" {
			hostBase = "http://localhost:8080"
		}
		hostToken := os.Getenv("SILO_PLUGIN_TOKEN")
		// Don't wire runtimeHost here: silo's host doesn't implement the
